...
Answer: the Africa is the most density continent and the South Africa is the most continent in plastic waste per cap
...
Answer here:Because here we represent a set of data (continents) , not just color control , as the colors here belong to the continents , and also the filling is related to the continents But the Alpha It is talking about all Graphic (gemo_density)
...
```
Answer: box plots provide corser summry of the data , provide more of a summary of a distribution can also be seen as an advantage in certain cases , also the point in the Graph or mapping It is most clearly than violin plots.
